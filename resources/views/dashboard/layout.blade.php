...
<head>
    ...
    <title>Dashboard - Nusa Putra</title>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">GENUSIAN</div>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
                <div class="sidebar-brand-text mx-3">Nusa Putra University</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/">
                    ...
                    <span>Website Nusa Putra</span></a>
            </li>
            <li class="nav-item active">
  ...
  <fieldset>
    ...
    <div class="mb-3">
  <label for="formFile" class="form-label">Tumbnail</label>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Muhammad Abdul Aziz - 20180040053</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
